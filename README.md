...
A token is used to show the api that you are a authenticated user and allows you access to the data.

- [ ] What steps can you take in your web apps to keep your data secure?

Use authentication, protected routes and not pushing sensitive data to your public GitHub.

- [ ] Describe how web servers work.

The web server receives a request, processes the request and sends a response.
